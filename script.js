//fetching data
var data = fetch('https://gist.githubusercontent.com/rvsp/add40254aa126f045837fa5b51f47f1f/raw/4d724bfabf4cce7379a386e23bef6576ab99a2f9/pagination.json')
.then(response => response.json());

//initiate Elements
var title = document.getElementById('title');
var description = document.getElementById('description');
var tableResponsive = document.querySelector('div.table-responsive');
...
buttons()
{
    data.then(data=>{
        ...
        if(this.firstIndex < data.length-11   && this.firstIndex >= 0)
        {
...
data.then(data=>{
   ...
   // navigation showing current and total page number
